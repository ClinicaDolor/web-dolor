    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                    <h4 class="card-title">Detalle Cofepris
                    </h4>
                    </div>
                    <div class="card-body">

                    <div class="float-end"><a target="_blank" href="/pdf/cofepris/<?=$data['id_cofepris'];?>" class="btn icon btn-primary"><i data-feather="printer"></i></a></div>
                <div><small class="text-primary">Fecha: </small> <label class="fs-5"><?=$data['fecha'];?></label>, <small class="text-primary">Hora: </small> <label class="fs-5"><?=$data['hora'];?></label></div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="mt-1"><small class="text-primary">Número de cajas: </small></div> <label class="fs-5"><?=$data['numcajas'];?></label>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6">
                        <div class="mt-1"><small class="text-primary">No. de días de prescripción: </small></div> <label class="fs-5"><?=$data['numdias'];?></label>
                    </div>
                    <div class="col-12 col-sm-6">
                        <div class="mt-1"><small class="text-primary">Via de administración: </small></div> <label class="fs-5"><?=$data['viaadministracion'];?></label>
                    </div>
                </div>
